...
const questions = {
  1: [
    ...
    { question: "Which insect is this? 🦋", options: ["Spider", "Butterfly", "Beetle"], answer: "Butterfly" },
    { question: "Which insect is this? 🐞", options: ["Wasp", "Fly", "Ladybug"], answer: "Ladybug" },
    { question: "Which insect is this? 🐜", options: ["Ant", "Beetle", "Moth"], answer: "Ant" },
    { question: "Which insect is this? 🪰", options: ["Bee", "Fly", "Moth"], answer: "Fly" },
    { question: "Which insect is this? 🦂", options: ["Spider", "Wasp", "Scorpion"], answer: "Scorpion" }
  ],
  2: [
    { question: "What is the role of the bee in nature?", options: ["Pollinator", "Predator", "Decomposer"], answer: "Pollinator" },
    ...
    { question: "What is the role of the butterfly?", options: ["Scavenger", "Hunter", "Pollinator"], answer: "Pollinator" },
    ...
    { question: "What does the mantis do in the food chain?", options: ["Decomposer", "Pollinator", "Predator"], answer: "Predator" }
  ],
  3: [
    ...
    { question: "How does the stick insect avoid predators?", options: ["Camouflages as a branch", "Makes noise", "Bites"], answer: "Camouflages as a branch" },
    { question: "How does the cockroach escape danger?", options: ["Freezes", "Flies away", "Runs quickly",], answer: "Runs quickly" }
  ]
};
...
function showFinalScore() {
  ...
  document.getElementById("game-container").innerHTML = `
    ...
    ">
      ...
      <h2 id="title-result" style="color: #4CAF50; margin: 20px 0; font-size: 22px;">
        ${title}
      </h2>
